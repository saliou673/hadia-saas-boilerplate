...
public class IntegrationTest {
    ...
    void resetDatabase() {
        ...
        jdbcTemplate.execute(
                "TRUNCATE TABLE app_user, user_preference, app_configuration, subscription_plan, user_subscription, discount_code, app_security_settings, app_tax_configuration, app_storage_settings, app_enterprise_profile RESTART IDENTITY CASCADE"
        );
