...
/**
 * MapStruct mapper extracting fields from an {@link com.hadiasaas.infrastructure.adapter.in.rest.controller.requests.UpdateAppConfigurationRequest} for use in service calls.
 */
@Mapper(
