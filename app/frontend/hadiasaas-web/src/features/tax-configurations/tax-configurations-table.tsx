...
import {
    ...
    type GetTaxConfigurationsAsAdminQueryParams,
    useGetTaxConfigurationsAsAdmin,
} from "@api-client";
...
import { buildTaxConfigurationsColumns } from "./tax-configurations-columns";
import { TaxConfigurationsToolbar } from "./tax-configurations-toolbar";

type TaxConfigurationsTableProps = {
...
export function TaxConfigurationsTable({
    search,
    navigate,
    onEdit,
    onDelete,
    onTotalItemsChange,
}: TaxConfigurationsTableProps) {
    ...
    const { data, isLoading, isError } =
        useGetTaxConfigurationsAsAdmin(queryParams);

    const items = data?.items ?? [];
    const totalPages = data?.totalPages ?? 0;
    const totalItems = data?.totalItems ?? 0;
    const columns = buildTaxConfigurationsColumns({ onEdit, onDelete });
