 ...
 */
export async function createPublicUserAccount(data: CreatePublicUserAccountMutationRequest, config: Partial<RequestConfig<CreatePublicUserAccountMutationRequest>> & { client?: Client } = {}) {
