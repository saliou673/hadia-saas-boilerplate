...
function getGetCurrentUserPermissionsUrl() {
  const res = { method: 'GET', url: `/api/v1/accounts/me/permissions` as const }
  return res
}
 ...
 */
export async function getCurrentUserPermissions(config: Partial<RequestConfig> & { client?: Client } = {}) {
