...
function getFinishPasswordResetUrl() {
  const res = { method: 'POST', url: `/api/v1/accounts/reset-password/finish` as const }
  return res
}
 ...
 */
export async function finishPasswordReset(data: FinishPasswordResetMutationRequest, config: Partial<RequestConfig<FinishPasswordResetMutationRequest>> & { client?: Client } = {}) {
