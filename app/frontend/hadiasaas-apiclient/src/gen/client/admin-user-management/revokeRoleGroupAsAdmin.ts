...
function getRevokeRoleGroupAsAdminUrl(id: RevokeRoleGroupAsAdminPathParams["id"], roleGroupId: RevokeRoleGroupAsAdminPathParams["roleGroupId"]) {
  const res = { method: 'DELETE', url: `/api/v1/admin/users/${id}/role-groups/${roleGroupId}` as const }
  return res
}
 ...
 */
export async function revokeRoleGroupAsAdmin(id: RevokeRoleGroupAsAdminPathParams["id"], roleGroupId: RevokeRoleGroupAsAdminPathParams["roleGroupId"], config: Partial<RequestConfig> & { client?: Client } = {}) {
