 ...
 */
export async function updateUserAsAdmin(id: UpdateUserAsAdminPathParams["id"], data: UpdateUserAsAdminMutationRequest, config: Partial<RequestConfig<UpdateUserAsAdminMutationRequest>> & { client?: Client } = {}) {
