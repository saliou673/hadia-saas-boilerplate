...
function getCheckUserPermissionAsAdminUrl(id: CheckUserPermissionAsAdminPathParams["id"]) {
  const res = { method: 'GET', url: `/api/v1/admin/users/${id}/permissions/check` as const }
  return res
}
 ...
 */
export async function checkUserPermissionAsAdmin(id: CheckUserPermissionAsAdminPathParams["id"], params: CheckUserPermissionAsAdminQueryParams, config: Partial<RequestConfig> & { client?: Client } = {}) {
