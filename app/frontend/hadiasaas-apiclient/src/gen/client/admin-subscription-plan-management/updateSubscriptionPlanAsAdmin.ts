 ...
 */
export async function updateSubscriptionPlanAsAdmin(id: UpdateSubscriptionPlanAsAdminPathParams["id"], data: UpdateSubscriptionPlanAsAdminMutationRequest, config: Partial<RequestConfig<UpdateSubscriptionPlanAsAdminMutationRequest>> & { client?: Client } = {}) {
