...
function getRenewSubscriptionUrl(id: RenewSubscriptionPathParams["id"]) {
  const res = { method: 'POST', url: `/api/v1/subscriptions/${id}/renew` as const }
  return res
}
 ...
 */
export async function renewSubscription(id: RenewSubscriptionPathParams["id"], config: Partial<RequestConfig> & { client?: Client } = {}) {
