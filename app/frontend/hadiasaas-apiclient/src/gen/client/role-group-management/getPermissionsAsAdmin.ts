...
function getGetPermissionsAsAdminUrl() {
  const res = { method: 'GET', url: `/api/v1/admin/role-groups/permissions` as const }
  return res
}
 ...
 */
export async function getPermissionsAsAdmin(params: GetPermissionsAsAdminQueryParams, config: Partial<RequestConfig> & { client?: Client } = {}) {
