...
function getUpdateRoleGroupAsAdminUrl(id: UpdateRoleGroupAsAdminPathParams["id"]) {
  const res = { method: 'PUT', url: `/api/v1/admin/role-groups/${id}` as const }
  return res
}
 ...
 */
export async function updateRoleGroupAsAdmin(id: UpdateRoleGroupAsAdminPathParams["id"], data: UpdateRoleGroupAsAdminMutationRequest, config: Partial<RequestConfig<UpdateRoleGroupAsAdminMutationRequest>> & { client?: Client } = {}) {
