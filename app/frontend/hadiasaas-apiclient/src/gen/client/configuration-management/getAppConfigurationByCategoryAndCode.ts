...
function getGetAppConfigurationByCategoryAndCodeUrl(category: GetAppConfigurationByCategoryAndCodePathParams["category"], code: GetAppConfigurationByCategoryAndCodePathParams["code"]) {
  const res = { method: 'GET', url: `/api/v1/configurations/${category}/${code}` as const }
  return res
}
 ...
 */
export async function getAppConfigurationByCategoryAndCode(category: GetAppConfigurationByCategoryAndCodePathParams["category"], code: GetAppConfigurationByCategoryAndCodePathParams["code"], config: Partial<RequestConfig> & { client?: Client } = {}) {
