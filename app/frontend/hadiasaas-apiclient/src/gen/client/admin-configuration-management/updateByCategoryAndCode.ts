...
function getUpdateByCategoryAndCodeUrl(category: UpdateByCategoryAndCodePathParams["category"], code: UpdateByCategoryAndCodePathParams["code"]) {
  const res = { method: 'PUT', url: `/api/v1/admin/configurations/${category}/${code}` as const }
  return res
}
 ...
 */
export async function updateByCategoryAndCode(category: UpdateByCategoryAndCodePathParams["category"], code: UpdateByCategoryAndCodePathParams["code"], data: UpdateByCategoryAndCodeMutationRequest, config: Partial<RequestConfig<UpdateByCategoryAndCodeMutationRequest>> & { client?: Client } = {}) {
