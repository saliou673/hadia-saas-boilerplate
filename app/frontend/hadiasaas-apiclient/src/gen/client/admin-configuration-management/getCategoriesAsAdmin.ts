...
function getGetCategoriesAsAdminUrl() {
  const res = { method: 'GET', url: `/api/v1/admin/configurations/categories` as const }
  return res
}
 ...
 */
export async function getCategoriesAsAdmin(config: Partial<RequestConfig> & { client?: Client } = {}) {
