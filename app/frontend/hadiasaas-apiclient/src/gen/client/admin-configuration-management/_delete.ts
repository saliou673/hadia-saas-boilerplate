...
function getDeleteUrl(id: DeletePathParams["id"]) {
  const res = { method: 'DELETE', url: `/api/v1/admin/configurations/${id}` as const }
  return res
}
 ...
 */
export async function _delete(id: DeletePathParams["id"], config: Partial<RequestConfig> & { client?: Client } = {}) {
