...
function getUpdateDiscountCodeAsAdminUrl(id: UpdateDiscountCodeAsAdminPathParams["id"]) {
  const res = { method: 'PUT', url: `/api/v1/admin/discount-codes/${id}` as const }
  return res
}
 ...
 */
export async function updateDiscountCodeAsAdmin(id: UpdateDiscountCodeAsAdminPathParams["id"], data: UpdateDiscountCodeAsAdminMutationRequest, config: Partial<RequestConfig<UpdateDiscountCodeAsAdminMutationRequest>> & { client?: Client } = {}) {
