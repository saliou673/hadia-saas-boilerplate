...
function getCreateDiscountCodeAsAdminUrl() {
  const res = { method: 'POST', url: `/api/v1/admin/discount-codes` as const }
  return res
}
 ...
 */
export async function createDiscountCodeAsAdmin(data: CreateDiscountCodeAsAdminMutationRequest, config: Partial<RequestConfig<CreateDiscountCodeAsAdminMutationRequest>> & { client?: Client } = {}) {
