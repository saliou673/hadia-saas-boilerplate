...
export const getAppConfigurationsSuspenseQueryKey = (params: GetAppConfigurationsQueryParams) => [{ url: '/api/v1/configurations' }, ...(params ? [params] : [])] as const

export type GetAppConfigurationsSuspenseQueryKey = ReturnType<typeof getAppConfigurationsSuspenseQueryKey>
...
export function useGetAppConfigurationsSuspense<TData = GetAppConfigurationsQueryResponse, TQueryKey extends QueryKey = GetAppConfigurationsSuspenseQueryKey>(params: GetAppConfigurationsQueryParams, options: 
{
 ...
 = {}) {
         ...
         const queryKey = queryOptions?.queryKey ?? getAppConfigurationsSuspenseQueryKey(params)
