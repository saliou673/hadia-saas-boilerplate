...
export const getAppConfigurationByCategoryAndCodeSuspenseQueryKey = (category: GetAppConfigurationByCategoryAndCodePathParams["category"], code: GetAppConfigurationByCategoryAndCodePathParams["code"]) => [{ url: '/api/v1/configurations/:category/:code', params: {category:category,code:code} }] as const

export type GetAppConfigurationByCategoryAndCodeSuspenseQueryKey = ReturnType<typeof getAppConfigurationByCategoryAndCodeSuspenseQueryKey>
...
export function useGetAppConfigurationByCategoryAndCodeSuspense<TData = GetAppConfigurationByCategoryAndCodeQueryResponse, TQueryKey extends QueryKey = GetAppConfigurationByCategoryAndCodeSuspenseQueryKey>(category: GetAppConfigurationByCategoryAndCodePathParams["category"], code: GetAppConfigurationByCategoryAndCodePathParams["code"], options: 
{
 ...
 = {}) {
         ...
         const queryKey = queryOptions?.queryKey ?? getAppConfigurationByCategoryAndCodeSuspenseQueryKey(category, code)
