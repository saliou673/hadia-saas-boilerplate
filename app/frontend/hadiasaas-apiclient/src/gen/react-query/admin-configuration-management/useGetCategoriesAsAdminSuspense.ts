...
export const getCategoriesAsAdminSuspenseQueryKey = () => [{ url: '/api/v1/admin/configurations/categories' }] as const

export type GetCategoriesAsAdminSuspenseQueryKey = ReturnType<typeof getCategoriesAsAdminSuspenseQueryKey>
...
export function useGetCategoriesAsAdminSuspense<TData = GetCategoriesAsAdminQueryResponse, TQueryKey extends QueryKey = GetCategoriesAsAdminSuspenseQueryKey>(options: 
{
 ...
 = {}) {
         ...
         const queryKey = queryOptions?.queryKey ?? getCategoriesAsAdminSuspenseQueryKey()
