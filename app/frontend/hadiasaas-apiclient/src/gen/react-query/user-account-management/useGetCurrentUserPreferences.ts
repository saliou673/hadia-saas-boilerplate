...
export const getCurrentUserPreferencesQueryKey = () => [{ url: '/api/v1/accounts/me/preferences' }] as const

export type GetCurrentUserPreferencesQueryKey = ReturnType<typeof getCurrentUserPreferencesQueryKey>
...
export function useGetCurrentUserPreferences<TData = GetCurrentUserPreferencesQueryResponse, TQueryData = GetCurrentUserPreferencesQueryResponse, TQueryKey extends QueryKey = GetCurrentUserPreferencesQueryKey>(options: 
{
 ...
 = {}) {
         ...
         const queryKey = queryOptions?.queryKey ?? getCurrentUserPreferencesQueryKey()
