...
export const activateAccountQueryKey = (params: ActivateAccountQueryParams) => [{ url: '/api/v1/accounts/activation' }, ...(params ? [params] : [])] as const

export type ActivateAccountQueryKey = ReturnType<typeof activateAccountQueryKey>
