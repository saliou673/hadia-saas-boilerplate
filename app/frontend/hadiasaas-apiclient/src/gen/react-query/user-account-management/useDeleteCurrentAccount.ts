...
export const deleteCurrentAccountMutationKey = () => [{ url: '/api/v1/accounts/me' }] as const

export type DeleteCurrentAccountMutationKey = ReturnType<typeof deleteCurrentAccountMutationKey>
