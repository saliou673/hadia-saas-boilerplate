...
export const getUserPermissionsAsAdminSuspenseQueryKey = (id: GetUserPermissionsAsAdminPathParams["id"]) => [{ url: '/api/v1/admin/users/:id/permissions', params: {id:id} }] as const

export type GetUserPermissionsAsAdminSuspenseQueryKey = ReturnType<typeof getUserPermissionsAsAdminSuspenseQueryKey>
...
export function useGetUserPermissionsAsAdminSuspense<TData = GetUserPermissionsAsAdminQueryResponse, TQueryKey extends QueryKey = GetUserPermissionsAsAdminSuspenseQueryKey>(id: GetUserPermissionsAsAdminPathParams["id"], options: 
{
 ...
 = {}) {
         ...
         const queryKey = queryOptions?.queryKey ?? getUserPermissionsAsAdminSuspenseQueryKey(id)
