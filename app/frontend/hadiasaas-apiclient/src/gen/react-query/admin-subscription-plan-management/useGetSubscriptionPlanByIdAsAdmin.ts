...
export const getSubscriptionPlanByIdAsAdminQueryKey = (id: GetSubscriptionPlanByIdAsAdminPathParams["id"]) => [{ url: '/api/v1/admin/plans/:id', params: {id:id} }] as const

export type GetSubscriptionPlanByIdAsAdminQueryKey = ReturnType<typeof getSubscriptionPlanByIdAsAdminQueryKey>
...
export function useGetSubscriptionPlanByIdAsAdmin<TData = GetSubscriptionPlanByIdAsAdminQueryResponse, TQueryData = GetSubscriptionPlanByIdAsAdminQueryResponse, TQueryKey extends QueryKey = GetSubscriptionPlanByIdAsAdminQueryKey>(id: GetSubscriptionPlanByIdAsAdminPathParams["id"], options: 
{
 ...
 = {}) {
         ...
         const queryKey = queryOptions?.queryKey ?? getSubscriptionPlanByIdAsAdminQueryKey(id)
