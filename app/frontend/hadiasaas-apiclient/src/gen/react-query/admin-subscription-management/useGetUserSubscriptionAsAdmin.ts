...
export const getUserSubscriptionAsAdminQueryKey = (params: GetUserSubscriptionAsAdminQueryParams) => [{ url: '/api/v1/admin/subscriptions' }, ...(params ? [params] : [])] as const

export type GetUserSubscriptionAsAdminQueryKey = ReturnType<typeof getUserSubscriptionAsAdminQueryKey>
...
export function useGetUserSubscriptionAsAdmin<TData = GetUserSubscriptionAsAdminQueryResponse, TQueryData = GetUserSubscriptionAsAdminQueryResponse, TQueryKey extends QueryKey = GetUserSubscriptionAsAdminQueryKey>(params: GetUserSubscriptionAsAdminQueryParams, options: 
{
 ...
 = {}) {
         ...
         const queryKey = queryOptions?.queryKey ?? getUserSubscriptionAsAdminQueryKey(params)
