...
export const getDiscountCodeStatusQueryKey = (code: GetDiscountCodeStatusPathParams["code"]) => [{ url: '/api/v1/discount-codes/:code/status', params: {code:code} }] as const

export type GetDiscountCodeStatusQueryKey = ReturnType<typeof getDiscountCodeStatusQueryKey>
...
export function useGetDiscountCodeStatus<TData = GetDiscountCodeStatusQueryResponse, TQueryData = GetDiscountCodeStatusQueryResponse, TQueryKey extends QueryKey = GetDiscountCodeStatusQueryKey>(code: GetDiscountCodeStatusPathParams["code"], options: 
{
 ...
 = {}) {
         ...
         const queryKey = queryOptions?.queryKey ?? getDiscountCodeStatusQueryKey(code)
