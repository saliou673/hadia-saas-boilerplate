...
export const getRoleGroupsAsAdminSuspenseQueryKey = (params: GetRoleGroupsAsAdminQueryParams) => [{ url: '/api/v1/admin/role-groups' }, ...(params ? [params] : [])] as const

export type GetRoleGroupsAsAdminSuspenseQueryKey = ReturnType<typeof getRoleGroupsAsAdminSuspenseQueryKey>
...
export function useGetRoleGroupsAsAdminSuspense<TData = GetRoleGroupsAsAdminQueryResponse, TQueryKey extends QueryKey = GetRoleGroupsAsAdminSuspenseQueryKey>(params: GetRoleGroupsAsAdminQueryParams, options: 
{
 ...
 = {}) {
         ...
         const queryKey = queryOptions?.queryKey ?? getRoleGroupsAsAdminSuspenseQueryKey(params)
