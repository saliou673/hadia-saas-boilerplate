...
export const confirm2FactorSetupMutationKey = () => [{ url: '/api/v1/accounts/me/2fa/setup/confirm' }] as const

export type Confirm2FactorSetupMutationKey = ReturnType<typeof confirm2FactorSetupMutationKey>
