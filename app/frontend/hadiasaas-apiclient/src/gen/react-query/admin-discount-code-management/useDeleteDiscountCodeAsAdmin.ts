...
export const deleteDiscountCodeAsAdminMutationKey = () => [{ url: '/api/v1/admin/discount-codes/:id' }] as const

export type DeleteDiscountCodeAsAdminMutationKey = ReturnType<typeof deleteDiscountCodeAsAdminMutationKey>
