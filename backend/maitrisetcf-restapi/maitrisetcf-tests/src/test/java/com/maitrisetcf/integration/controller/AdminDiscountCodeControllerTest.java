...
class AdminDiscountCodeControllerTest extends IntegrationTest {
    ...
    private com.maitrisetcf.infrastructure.adapter.out.persistence.entity.DiscountCodeEntity createDiscountCodeCurrency(
            String code,
        ...
        var entity = new com.maitrisetcf.infrastructure.adapter.out.persistence.entity.DiscountCodeEntity(
                null,
                code,
                discountType,
                discountValue,
