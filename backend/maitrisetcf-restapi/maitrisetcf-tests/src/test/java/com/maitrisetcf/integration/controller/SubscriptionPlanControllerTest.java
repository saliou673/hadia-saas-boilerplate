...
class SubscriptionPlanControllerTest extends IntegrationTest {
    ...
    void shouldReturnCustomCyclePlan() throws Exception {
        ...
        assertThat(result).hasSize(1);
        assertThat(result.getFirst().getPrice()).isEqualByComparingTo("4.99");
        assertThat(result.getFirst().getDurationDays()).isEqualTo(14);
        assertThat(result.getFirst().getMonthlyPrice()).isNull();
    }
    ...
    void shouldReturnLifetimePlan() throws Exception {
        ...
        assertThat(result).hasSize(1);
        assertThat(result.getFirst().getLifetimePrice()).isEqualByComparingTo("199.99");
        assertThat(result.getFirst().getMonthlyPrice()).isNull();
    }
